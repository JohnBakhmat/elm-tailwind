...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-screen bg-black text-white h-screen grid place-items-center')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex flex-row gap-5 text-xl w-full place-content-center')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('bg-white aspect-square rounded-md w-10 text-black font-bold grid place-items-center')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('-')
